...
public class PassengerView {
    ...
    // Different States of the Passenger 
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Creating default Passenger object with default names 
        Passenger passenger = new Passenger("Adam Adams","1029462","adam@abc.com");
        ...
        try (
            ...
            while ((fromServer = in.readObject()) != null) {
                ...
                if(state == IN_CONVERSATION) {
                     ...
                     // Determine that sending as passenger 
                     messageOut = new Message(username, "passenger");
                }
